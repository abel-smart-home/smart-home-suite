# Smart Home Suite 1.2.0 — Smart Home configurable cards PRE-RELEASE

Pre-release para validación en laboratorio. No promover a estable hasta completar `TEST-CHECKLIST-1.2.0.md` en HAOS real.
...
7. Completar `TEST-CHECKLIST-1.2.0.md`.
...
Crear el release GitHub con tag `v1.2.0`, marcar **Set as a pre-release** y no marcarlo como Latest. Si termina el checklist sin regresiones, editar este mismo release y quitar la marca de pre-release; no es necesario crear otro tag.
