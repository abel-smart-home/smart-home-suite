...
- Smart Home Suite / Manager: **0.5.0 TEST**
...
La 0.5.0 es un candidato de laboratorio. No publicar release hasta completar
`TEST-CHECKLIST-0.5.0.md`.

## Smart Home Suite 0.5.0
...
Fase de robustez: validación CI previa a construir, instalación con rollback,
recuperación de sustituciones interrumpidas, backups verificados y Repairs de
Home Assistant cuando un módulo habilitado no puede cargar.
